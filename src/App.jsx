        ...
        <div className="max-w-14xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8">
              ...
              <li><a href="/personal-color-app/#/capture" className="tracking-tight text-white hover:text-primary transition-colors">controll</a></li>
            </ul>
          </nav>
        </div>
      </header> */}
      <main className={`flex-1 ${isLandingPage ? 'overflow-y-auto snap-y snap-mandatory' : 'overflow-y-auto'}`}>
        <Routes>
