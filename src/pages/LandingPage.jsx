    ...
    <div className="snap-y snap-mandatory h-screen w-full overflow-y-auto scroll-smooth overflow-x-hidden">
      <section className="snap-start h-screen w-full flex items-center justify-center">
        <div className="text-center max-w-4xl mx-auto px-6">
          <h2 className="text-6xl font-bold mb-8 text-gray-800 modern-text tracking-tight">
            <span className="block mb-3">당신만의</span>
            <span className="text-gradient">컬러</span>를 발견하세요
          </h2>
          <p className="text-xl mb-10 text-gray-600 max-w-2xl mx-auto leading-relaxed tracking-wide">
      ...
      <section className="snap-start h-screen w-full flex items-center justify-center">
        <div className="bg-white rounded-xl border border-gray-200 p-12 hover:shadow-2xl transition-all duration-300 max-w-2xl mx-6">
          <div className="mb-8">
          ...
          <h3 className="text-3xl font-semibold mb-8 text-gray-800 text-center">간편한 <span className="text-gradient">사진 촬영</span></h3>
      ...
      <section className="snap-start h-screen w-full flex items-center justify-center">
        <div className="bg-white rounded-xl border border-gray-200 p-12 hover:shadow-2xl transition-all duration-300 max-w-2xl mx-6">
          ...
          <h3 className="text-3xl font-semibold mb-8 text-gray-800 text-center"><span className="text-gradient">AI 기반</span> 분석</h3>
          <p className="text-gray-600 text-xl text-center leading-relaxed">
      ...
      <section className="snap-start h-screen w-full flex items-center justify-center">
        <div className="bg-white rounded-xl border border-gray-200 p-12 hover:shadow-2xl transition-all duration-300 max-w-2xl mx-6">
          ...
          <h3 className="text-3xl font-semibold mb-8 text-gray-800 text-center">맞춤형 <span className="text-gradient">컬러 팔레트</span></h3>
          <p className="text-gray-600 text-xl text-center leading-relaxed">
      ...
      <section className="snap-start h-screen w-full flex items-center justify-center">
        <div className="text-center max-w-4xl px-6">
          <h3 className="text-3xl font-semibold mb-8 text-gray-800 modern-text">퍼스널 <span className="text-gradient">컬러</span>란?</h3>
